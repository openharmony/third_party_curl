...
struct curl_easyoption Curl_easyopts[] = {
  ...
  {"SNI_HOSTNAME", CURLOPT_SNI_HOSTNAME, CURLOT_STRING, 0},
  ...
  {"SSLPARTIALCHAIN", CURLOPT_SSLPARTIALCHAIN, CURLOT_LONG, 0},
  ...
  {"OHOS_SOCKET_BIND_NET_ID", CURLOPT_OHOS_SOCKET_BIND_NET_ID, CURLOT_LONG, 0},
  {"CONNREUSEFUNCTION", CURLOPT_CONNREUSEFUNCTION, CURLOT_FUNCTION, 0},
  {"CONNREUSEDATA", CURLOPT_CONNREUSEDATA, CURLOT_CBPTR, 0},
#endif
  {"MMS_RESERVED_DEFAULT_PORT", CURLOPT_MMS_RESERVED_DEFAULT_PORT, CURLOT_LONG, 0},
#ifdef HTTP_DEADFLOWRESET_FEATURE
  {"USER_TIME_OUT", CURLOPT_USER_TIME_OUT, CURLOT_LONG, 0},
  {"USER_TIME_OUT_FUNCTION", CURLOPT_USER_TIME_OUT_FUNCTION, CURLOT_FUNCTION, 0},
  {"USER_TIME_OUT_DATA", CURLOPT_USER_TIME_OUT_DATA, CURLOT_CBPTR, 0},
#endif
